...
ACar::ACar()
{
 	// Set this pawn to call Tick() for every frame.
...
void ACar::Tick(float DeltaTime)
{
	...
	if (this->isPossessed) {
		result[0] = RotationPlayer;
		// *SmoothInput + (1.f - SmoothInput)*result[!actual][0];
		//When wanting smooth transit
	}
	else {
